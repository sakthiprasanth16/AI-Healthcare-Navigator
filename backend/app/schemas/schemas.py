...
class SelectLabRequest(BaseModel):
    ...
    # Without this, a multi-test visit's combined price had no way to be
    # split back apart later (e.g. in the Spending Tracker), since only the
    # single combined total was ever stored.
    test_prices: Optional[List[LabTestPrice]] = None
