  ...
  const handleSelectLab = async (lab: LabResult) => {
    ...
    try {
      await api.post('/labs/select', {
        ...
        // Per-test breakdown — without this, a multi-test visit's combined
        // price had no way to be split back apart later in Spending Tracker.
        test_prices: lab.test_prices ?? null,
      });
